...
namespace Buffers.Managers
{
	public struct OldOldTnConfig
	{
		...
		public OldOldTnConfig(bool AdjustDRWhenReadInDR, bool EnlargeCRWhenReadInDNR,
...
#pragma warning disable 0618
	public sealed class OldOldTn : FrameBasedManager
#pragma warning restore 0618
	{
		private readonly MultiConcatLRUQueue<IFrame> q;

		private readonly OldOldTnConfig conf;
		private readonly float kickn;
		private float crlimit_;
		private readonly uint CNRLimit, DNRLimit;


		public OldOldTn(uint npages, float kickN)
			: this(null, npages, kickN) { }

		public OldOldTn(IBlockDevice dev, uint npages, float kickN)
			: this(dev, npages, kickN, new OldOldTnConfig()) { }

		public OldOldTn(uint npages, float kickN, OldOldTnConfig conf)
			: this(null, npages, kickN, conf) { }

		public OldOldTn(IBlockDevice dev, uint npages, float kickN, OldOldTnConfig conf)
			: base(dev, npages)
		{
